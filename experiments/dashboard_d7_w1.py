...
# Factorisé dans multiseed_badge_common.py (sans dépendance lourde -- réutilisé
# tel quel par model_artifacts/generate_dashboard.py, dont l'environnement CI de
# déploiement n'installe QU'une dépendance minimale, cf. ce module pour le détail
# du bug que ça a causé). Réexporté ici pour compatibilité (noms encore utilisés
# comme dashboard_d7_w1.<nom> ailleurs dans ce dépôt).
from multiseed_badge_common import (                                    # noqa: E402
    MULTISEED_MODELS, TARGET_ENSEMBLE_LABEL, DEFAULT_MULTISEED_JSON,
